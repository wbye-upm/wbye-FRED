...
cf_RES      = [    15,     15,     15,     15,     15,     15,     15,     15,     15,     15,     15,     15,     15,     15,     15,     15,     15,     15,     15,     15,     15,     15,     15,     15] ./ 15
# Fix P_L
P_L_fixed   = [   500,    550,    600,    650,    700,    750,    800,    850,    900,    950,   1000,   1050,   1100,   1150,   1200,   1250,   1300,   1350,   1400,   1450,   1500,    1520,   1520,   1520]
...
if termination_status(model) == OPTIMAL || termination_status(model) == LOCALLY_SOLVED
    ...
    PFR_values = [round(sum(value(Rg[g, t]) for g in 1:nTypes), digits=2) for t in 1:T]
